...
<!-- Mirrored from itwill.xyz/generic/main/policy.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jul 2021 10:13:31 GMT -->
         ...
         <div class="row">
           <div class="col-md-12">
              <div class="title-section text-center mb-5 col-12">
                <h2 class="text-uppercase">이용약관</h2><br>           
            </div>        
        
            <b>제1조(목적) 이 약관은 (주)제네릭몬스터(전자상거래 사업자)가 운영하는 사이버 
                (이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를
                이용함에 있어 사이버 몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</b><br/><br/>
                
                <i>※「PC통신, 무선 인터넷, 모바일 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</i><br/><br/><br/>
                ...
                ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 팩스번호, 전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 사이버 몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br/>
                ...
                상품 정보검색서비스<br/>
                “㈜제네릭몬스터”가 제공하는 전자상거래 관련 각종 정보 제공<br/>
                고객상담서비스<br/>
                “회원”이용 서비스<br/>
                기타 “몰”이 정하는 업무<br/>
                
                ② “몰”은 재화 또는 용역의 품절 또는 기술적 사양의 변경 등의 경우에 장차 체결되는 계약에 의해 제공할 재화 또는 용역의 내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에 즉시 공지합니다.<br/>
                ...
                “몰”이 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.<br/><br/>
                ...
                가입신청자가 이 약관 제7조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조 제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 “몰”의 회원재가입 승낙을 얻은 경우에는 예외로 한다.<br/>
                ...
                ⑤ 만 14세 미만 고객의 회원가입을 허용할 경우, 관련 법령에 따라 법정대리인 동의서가 필요합니다.<br/><br/>
                ...
                ② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일 이상 “몰” 게시판에 게시 함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.<br/><br/>
                ...
                재화 등의 검색 및 선택<br/>
                받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호) 등의 입력<br/>
                ...
                ② “몰”은 이용자가 구매한 재화에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을 명시합니다. 만약 “몰”이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다. 다만 “몰”이 고의 또는 과실이 없음을 입증한 경우에는 그러하지 아니합니다.<br/>
                
                ③ 제2항의 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등은 “몰”의 정책으로 변경될 수 있으며 이러한 경우 “몰”은 이 약관 제 3조 제 4항에 따라 그 변경내용을 공지합니다.<br/><br/>
                
                
                <b>제14조(환급)</b><br/>
                
                “몰”은 이용자가 구매 신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다. 단, “몰”의 귀책사유 없이 “이용자”에 대한 통지가 어려운 경우에는 3 영업일 이상의 기간이 소요될 수 있습니다.<br/><br/>
                ...
                ② 이용자는 재화 등을 배송 받은 경우 다음 각 호에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br/>
                ...
                “몰”이 특정 “재화 등”에 관한 반품 및 교환의 제한을 사전에 고지한 경우<br/>
                ...
                ① “몰”은 이용자로부터 재화 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 경우 “몰”이 이용자에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」 제21조의 2에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.<br/>
                ...
                성명<br/>
                본인확인기관에서 제공하는 본인인증결과값(CI)<br/>
                주소(배송지와 다른 경우 배송지 포함)<br/>
                연락처(전화번호 또는 이동전화번호)<br/>
                “회원”ID와 비밀번호(“회원”인 경우)<br/>
                결제에 필요한 정보<br/>
                전자우편주소<br/>
                ...
                ④ “몰”은 수집된 개인정보를 목적 외의 용도로 이용할 수 없으며, 새로운 이용목적이 발생한 경우 또는 제3자에게 제공하는 경우에는 이용·제공단계에서 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. 다만, 다음 각 호의 경우에는 예외로 합니다.<br/>
                
                배송업무상 배송업체에게 배송에 필요한 최소한의 이용자의 정보(성명, 주소, 전화번호)를 알려주는 경우<br/>
                통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우<br/>
                “재화 등”의 거래에 따른 대금정산을 위하여 필요한 경우<br/>
                도용방지를 위하여 본인확인에 필요한 경우<br/>
                국가기관의 적법한 절차에 의해 정보공개가 요구되는 경우<br/>
                기타 관련 법령에 달리 정함이 있는 경우<br/>
                ...
                ⑨ “몰”은 개인정보의 수집 · 이용 · 제공에 관한 동의 란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집 · 이용 · 제공에 관한 이용자의 동의거절 시 제한되는 서비스를 구체적으로 명시하고, 필수수집항목이 아닌 개인정보의 수집·이용·제공에 관한 이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나 거절하지 않습니다.<br/><br/>
                
                
                
                <b>제18조(“몰”의 의무)</b><br/>
                
                ① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화 및 용역을 제공하는데 최선을 다하여야 합니다.<br/>
                ...
                ③ 회원이 자신의 ID 및 비밀번호를 도난 당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로 “몰”에 통보하고 “몰”의 안내가 있는 경우에는 그에 따라야 합니다.<br/><br/>
                ...
                <b>제21조(연결 “몰”과 피 연결 “몰”간의 관계)</b><br/>
                
                ① 상위 “몰”과 하위 “몰”이 하이퍼링크(예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결 “몰”(웹 사이트)이라고 하고 후자를 피 연결 “몰”(웹사이트)이라고 합니다.<br/>
                
                ② 연결 “몰”은 피 연결 “몰”이 독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을 연결“몰”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증 책임을 지지 않습니다.<br/><br/>
                ...
                ① “몰”은 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구를 설치 및 운영합니다.<br/>
                ...
                ② 이 약관 및 “몰”과 관련하여 발생한 모든 분쟁의 준거법은 대한민국 법으로 합니다.<br/>
                
                부칙.<br/>
                
                제 1조(시행일) 이 약관은 2014년 6월부터 시행합니다.<br/>
                제 2조(최종수정일) 공정거래위원회가 제공하는 전자상거래(인터넷사이버몰) 표준약관 제10023호(2015.6.26. 개정)에 따라 수정하였음.<br/>
