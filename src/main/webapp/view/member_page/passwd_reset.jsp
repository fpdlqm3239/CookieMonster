...
<body> 
    ...
    <div class="site-section">
      ...
      <form id="change_pw" name="findForm" action="<%=request.getContextPath()%>/view/member_page/passwd_reset_action.jsp" method="post" onsubmit="return;">
              ...
              <div class="form-group">
				...
				<div class="form-group row">
					<div class="col-md-12">
						...
						<input type="text"	class="form-control" id="mid" name="mid"  value="<%=email %>" readonly="readonly">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-12">
