	...
	<div class="site-section">
		...
		<div class="container">
			...
			<form id="join" name="joinForm"
				action="<%=request.getContextPath()%>/view/member_page/join_action.jsp"
				method="post">
					...
					<div class="col-md-9 offset-md-3">
						...
						<div class="p-6 p-sm-6 border-light">
							...
							<div class="form-group row" style="margin-bottom: -1px;">
								<div class="col-md-6">
									<input type="text" class="form-control" id="mid" name="mid"
										placeholder="이메일(아이디) 입력" value="">
								</div>
								<div class="col-md-2">
									<input type="button"
										class="btn btn-outline-dark btn-sm btn-block"
										style="height: 38px;" id="idCheck" value="중복체크" />
								</div>
							</div>

							<div class="form-group row">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="idMsg" class="error">이메일을
									입력해주세요.</span> <span id="idRegMsg" class="error">입력한 이메일이 형식에
									맞지 않습니다.</span>
								<div id="idCheckMsg" class="error">이메일 중복 검사를 실행해 주세요.</div>
							</div>
								...
								<div class="col-md-12 ">
									...
									<div class="col-xs-1 form-inline">
										<select name="mphone1" class="form-control">
											...
											name="mphone2" id="mphone2" size="4" maxlength="4">
										&nbsp;-&nbsp;<input type="text" class="form-control"
											name="mphone3" id="mphone3" size="4" maxlength="4">
									</div>
							...
							<div class="form-group row">
								<div class="col-md-6">
									<input type="text" class="form-control" id="maddress1"
										name="maddress1" placeholder="우편번호 입력" readonly="readonly">
								</div>
								<div class="col-md-2">
									<input type="button"
							...
							<div class="form-group row" style="text-align: center;">
								<div class="col-md-8">
									<input type="checkbox" id="user_check" name="user_check" /> <a
										href="<%=request.getContextPath()%>/view/policy_page/policy.jsp" target="_blank">이용약관</a>과 <a
										href="<%=request.getContextPath()%>/view/policy_page/personal.jsp" target="_blank">개인정보약관</a>에 동의함
									<div id="checkMsg" class="error">이용약관에 동의해주세요.</div>
									<button type="submit"
										class="btn btn-outline-dark btn-md btn-block" id="join_btn"
										style="margin-top: 20px;">신규가입</button>
								</div>
							</div>
						</div>
					</div>
