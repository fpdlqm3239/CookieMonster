...
<%if(category!=null){ %>
          ...
          <div class="custom-border-bottom py-3">
            <div class="container">
              <div class="row">
                <div class="col-md-12 mb-0"><a href="../index-2.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><%if(category !=null){%><%if(category.equals("glasses")){ %>안경<%}else if(category.equals("sunglass")){%>선글라스<%} %><%}else if(keyword!=null){ %>검색어 : <%=keyword%><%}else{%>전체<%} %></strong></div>
                </div>
              </div>
            </div>
          </div>
